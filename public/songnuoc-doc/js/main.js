...
//Dragging Button (BUG không thể click mở thay đổi value của buttom trong màn hình cảm ứng)
...
//   e.preventDefault(); // Ngăn scroll (touch)
//   const { x, y } = getClientCoords(e);
//   isDragging = true;
//   offsetX = x - button.offsetLeft;
//   offsetY = window.innerHeight - y - parseFloat(getComputedStyle(button).bottom);
